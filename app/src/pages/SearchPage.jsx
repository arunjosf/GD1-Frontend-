          ...
          {activeVehicle && (
            <div className="flex items-center w-full max-w-full md:w-auto bg-gray-50 border border-black/[0.08] rounded-full p-1 h-[46px] overflow-hidden min-w-0">
              ...
              >
                ...
                <p className="text-[13px] font-semibold text-[#111] leading-none truncate block w-full">{activeVehicle.brand} {activeVehicle.model}</p>
              </div>
              <button 
                onClick={() => {
                ...
                className="h-full shrink-0 px-4 ml-auto text-[12px] font-semibold text-blue-600 bg-white border border-black/[0.04] rounded-full hover:bg-blue-50 transition-colors shadow-sm whitespace-nowrap"
              >
                Change
              </button>
            </div>
