          ...
          {activeVehicle && (
            <div className="flex items-center bg-gray-50 border border-black/[0.08] rounded-full p-1 shrink-0 h-[46px]">
              ...
              <button 
                ...
                className="h-full px-4 ml-43 lg:ml-1 text-[12px] font-semibold text-blue-600 bg-white border border-black/[0.04] rounded-full hover:bg-blue-50 transition-colors shadow-sm"
              >
                Change
              </button>
            </div>
