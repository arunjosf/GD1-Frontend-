...
export default function PreRideConditionPage() {
  const { id } = useParams();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = await res.json();
      if (data.success) {
        toast.success('Pre-Ride condition submitted!');
  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-6 pb-24 animate-fade-in p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-black text-gray-900 tracking-tight">Pre-Ride Condition</h2>
          <p className="text-gray-500 text-sm mt-0.5">Final check before starting transit for Pickup #{id}</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 space-y-8">
        ...
        <div className="space-y-3">
          ...
          <textarea 
            ...
            placeholder="E.g. Starting transit to garage. Interior looks clean."
