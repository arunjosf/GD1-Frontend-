...
export default function ManagerVehiclesPage() {
  ...
  const fetchVehicles = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://gd1-grand-auto-depot-one-9ms1.onrender.com/api/lot-manager/vehicles`, {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredVehicles.map((vehicle, idx) => (
            <div 
              ...
              onClick={() => navigate(`/lot-manager/vehicle-details/${vehicle.vehicleId}?bookingId=${vehicle.bookingId}`, { state: { bookingId: vehicle.bookingId } })}
            >
              {/* Image Section */}
                    ...
                    return (
                      <div className="mt-4 pt-3 border-t border-gray-100">
                        <div 
                          onClick={(e) => {
                            e.stopPropagation();
                            navigate(`/lot-manager/vehicle-journey/${vehicle.vehicleId}`, { state: { bookingId: vehicle.bookingId } });
                          }}
