...
import LotOwnerSidebar from './LotOwnerSidebar';
import NotificationSidebar from './NotificationSidebar';

export default function LotOwnerLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#f3f6fc] flex font-['Inter',sans-serif]">
      ...
      {/* Sidebar Component */}
      <LotOwnerSidebar isMobileOpen={isSidebarOpen} setIsMobileOpen={setIsSidebarOpen} />
      ...
      <main className="flex-1 flex flex-col min-w-0 lg:ml-[260px]">
        ...
        <header className="h-24 px-8 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-[22px] font-semibold text-[#111] hidden sm:block">Lot Owner Dashboard</h1>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="h-10 w-10 rounded-full bg-gray-100 shadow-sm flex-shrink-0 ml-2 border border-gray-200 flex items-center justify-center text-gray-700 font-bold text-[18px]">
